...
@section('content')
    <div class="p-6 max-w-3xl mx-auto" x-data="userSearch()">
        ...
        <div class="flex flex-col md:flex-row justify-between items-stretch gap-4 mb-4">
            ...
            <div class="flex w-full md:max-w-md gap-2">
                ...
                <div class="relative flex-1">
                    <input type="text" x-model="searchTerm" @input="debounceSearch()"
            ...
            <div>
                <a href="{{ route('dashboard.users.create') }}"
                    class="bg-black hover:bg-gray-700 text-white font-medium px-4 py-2 rounded-lg flex items-center gap-2">
        ...
        <div id="users-container">
            @include('dashboard.users.partials.table', ['users' => $users])
        </div>
    </div>
